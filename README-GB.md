...
python test.py --dataroot ./datasets/box33/eval --name box33_pix2pix --model test --netG resnet_9blocks --direction AtoB --dataset_mode single --gpu_id -1 --norm batch  --preprocess none
```
...
```
python train.py --dataroot ./datasets/box33/ready --name box33_pix2pix --model pix2pix --direction AtoB --gpu_ids 0 --no_flip --batch_size 4 --display_freq 100  --netG unet_256  --load_size 1024 --crop_size 1024 --save_latest_freq 2000 --save_epoch_freq 1 --lr .0003 --continue_train
